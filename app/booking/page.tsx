          ...
          {step === 1 ? (
            ...
            >
               ...
               <div className="text-center">
                  <div className="flex items-center justify-center gap-2 text-[#C6A87C] mb-4">
                     <Calendar size={18} />
                     <span className="text-xs tracking-[0.3em] uppercase font-bold">Appointment Booking</span>
                  </div>
                  <h1 className="text-4xl md:text-6xl font-black font-serif text-white">
                    رزرو نوبت <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C6A87C] to-white">آنلاین</span>
                  </h1>
               </div>
                 ...
                 <div className="lg:col-span-2 space-y-12">
                   ...
                   <div className="space-y-6">
                      <div className="flex items-center gap-4 border-b border-white/5 pb-4">
                        <span className="bg-[#C6A87C] text-black w-8 h-8 rounded-full flex items-center justify-center text-sm font-black shadow-[0_0_15px_rgba(198,168,124,0.4)]">1</span>
                   ...
                   <div className="space-y-6">
                      <div className="flex items-center gap-4 border-b border-white/5 pb-4">
                        <span className="bg-[#C6A87C] text-black w-8 h-8 rounded-full flex items-center justify-center text-sm font-black shadow-[0_0_15px_rgba(198,168,124,0.4)]">2</span>
                   ...
                   <div className="space-y-6">
                      <div className="flex items-center gap-4 border-b border-white/5 pb-4">
                        <span className="bg-[#C6A87C] text-black w-8 h-8 rounded-full flex items-center justify-center text-sm font-black shadow-[0_0_15px_rgba(198,168,124,0.4)]">3</span>
                        ...
                        {DATES.map((date, idx) => (
                          <button
                            ...
                            className={`flex-1 min-w-[70px] py-4 rounded-xl flex flex-col items-center gap-1 transition-all
                              ${!date.active ? "opacity-30 cursor-not-allowed grayscale" : 
                                selectedDate.date === date.date 
                                  ? "bg-[#C6A87C] text-black shadow-lg scale-105 font-bold" 
                                  : "hover:bg-white/10 text-gray-400"}`}
                          >
                            <span className="text-[10px] uppercase tracking-wider">{date.day}</span>
                      ...
                      <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-7 gap-3">
                        {TIME_SLOTS.map((time) => (
                          ...
                          >
                            <Clock size={12} className={selectedTime === time ? "text-black" : "text-gray-500"} />
                            {time}
                          </button>
                        ))}
                      </div>
                    ...
                    <div className="bg-[#111] border border-white/10 rounded-[2.5rem] p-8 sticky top-32 shadow-2xl backdrop-blur-xl">
                       ...
                       <div className="space-y-6 mb-8">
                          <div className="flex items-center gap-4">
                             ...
                             <div>
                                <span className="text-[10px] text-[#C6A87C] uppercase tracking-widest block mb-1">Service</span>
                          ...
                          <div className="flex items-center gap-4">
                             ...
                             <div>
                                <span className="text-[10px] text-[#C6A87C] uppercase tracking-widest block mb-1">Stylist</span>
                          ...
                          <div className="flex items-center gap-4">
                             ...
                             <div>
                                <span className="text-[10px] text-[#C6A87C] uppercase tracking-widest block mb-1">Date & Time</span>
            ...
            >
              ...
              <div className="space-y-4">
                 <h2 className="text-4xl md:text-5xl font-black text-white font-serif">رزرو شما <span className="text-[#C6A87C]">قطعی شد!</span></h2>
                 ...
                 <div className="inline-flex items-center gap-2 bg-[#1a1a1a] px-4 py-2 rounded-full border border-white/10">
                    ...
                    <span className="text-sm text-gray-300">کد رهگیری: <span className="font-mono text-white font-bold">{bookingId}</span></span>
                 </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md z-10">
                ...
                >
                  {isDownloading ? (
                    <span className="animate-pulse flex items-center gap-2"><Download size={20} className="animate-bounce"/> در حال ذخیره...</span>
                  ) : (
                    <>
              ...
              <div className="bg-[#C6A87C]/5 border border-[#C6A87C]/10 rounded-2xl p-4 flex items-center gap-3 text-sm text-[#C6A87C] mt-4 max-w-md">
                ...
                <p className="text-right">پیشنهاد: با اشتراک‌گذاری این کارت در استوری اینستاگرام، از <span className="font-bold underline">۱۰٪ تخفیف</span> در خدمات بعدی بهره‌مند شوید.</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
